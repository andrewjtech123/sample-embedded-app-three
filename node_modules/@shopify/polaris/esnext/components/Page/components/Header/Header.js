...
class Header extends React.PureComponent {
    ...
    render() {
        const { title, titleMetadata, breadcrumbs = [], titleHidden = false, primaryAction, pagination, separator, secondaryActions, icon, polaris: { intl }, } = this.props;
        if (icon) {
        ...
        const actionsMarkup = (<div className={styles.Actions}>
        {primaryActionMarkup}
